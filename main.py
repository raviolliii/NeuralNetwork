...
# main.py
# 
# Main driver/tester code for the NeuralNet. Creates two
# networks, one for training/testing for recognizing 
# handwritten digits, and another for drawing them out.
# ===========================================================
...
def recognize():
    """
    Creates, trains, and tests a network for classifying
    handwritten digits into their actual values
    """
...
def draw():
    """
    Creates, trains, and tests a network for drawing out
    what it thinks is a digit (creates a series of.png 
    files under the /drawings directory)
    """
